    ...
    : AudioProcessorEditor (&p), processor (p)
{
	...
	flutterFreqLabel = new Label("", "Satu Freq");
	flutterDepthLabel = new Label("", "Satu Depth");
	wowFreqLabel = new Label("", "Dist Freq");
	wowDepthLabel = new Label("", "Dist Depth");
...
void AnotherDelayAudioProcessorEditor::paint (Graphics& g)
{
	...
	g.drawFittedText("Saturation & Distrotion", modRectangle.reduced(3), Justification::topRight, 1);
